...
trainDatanew=trainData(:,1:10000);
trainLabelsnew=trainLabels(1:10000,1);
%%======================================================================
...
trainDatanew=trainData(:,10001:20000);
trainLabelsnew=trainLabels(10001:20000,1);
[sae1OptTheta, cost] = minFunc( @(p) sparseAutoencoderCost(p, ...
                                   inputSize, hiddenSizeL1, ...
                                   lambda, sparsityParam, ...
                                   beta, trainDatanew), ...
...
[sae2OptTheta, cost] = minFunc( @(p) sparseAutoencoderCost(p, ...
                                   ...
                                   lambda, sparsityParam, ...
                                   beta, sae1Features(:,1:20000)), ...
                                   sae2Theta, options);
 [sae2OptTheta, cost] = minFunc( @(p) sparseAutoencoderCost(p, ...
                                   hiddenSizeL1, hiddenSizeL2, ...
                                   lambda, sparsityParam, ...
                                   beta, sae1Features(:,20001:40000)), ...
...
[stackedAEOptTheta, cost] = minFunc( @(p) stackedAECost(p, inputSize, hiddenSizeL2, ...
                                              numClasses, netconfig, lambda, ...
                                              trainData(:,1:20000), trainLabels(1:20000,:)), stackedAETheta, options);
